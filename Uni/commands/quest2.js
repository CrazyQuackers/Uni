            ...
            case 6:
                switch(sm.task)
                {
                    ...
                    case 12:
                        ...
                        sm.obj4++;
                        if(o2>3000){o2=3000}
                        createQuestMessage("🗺️ Quest #6 - Ghost Hunter Captain Finsley","📖 **__Task #12/19__** : It's Raining Gems\n\n\`Avast ye! I'm not going to need ye to fetch me some treasure. Collect a total of 3,000 Gems. I'll be willing to split me treasure with ya!\`","https://imgur.com/wxt9Iew.png","📜 __Goals:__",`• Collect **3,000** <:gems:825122942413045791> Gems from anywhere: ${coinToStr(o2)}/3,000`,message,sm,fs,q)
                        break;
                    case 13:
