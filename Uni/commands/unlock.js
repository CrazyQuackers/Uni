exports.run = async (bot,message,args) => {
    ...
    if(!ez.constructionOpen){mainUnlockFunction("The 🏗️ Construction Site!",ez,message,"https://imgur.com/7n2Q3yp.png",fs,db,"https://imgur.com/U7rqkGV.png","https://imgur.com/jdFgVvO.png","https://imgur.com/EwTDV9f.png","https://imgur.com/hwsNzI6.png","https://imgur.com/IkrHJBk.png","https://imgur.com/PSyHjRx.png","https://imgur.com/hTtYVXn.png")}else{if(!ez.pyramidsOpen){mainUnlockFunction("The <:pyramid:825122937236357164> Pyramids!",ez,message,"https://i.imgur.com/QDKvubk.png",fs,db,"https://imgur.com/JndFjCc.png","https://imgur.com/V1daYDS.png","https://imgur.com/MCBWUsY.png","https://imgur.com/Wu4Ar21.png","https://imgur.com/4sf9J3c.png","https://imgur.com/sWvtcxh.png","https://imgur.com/l0rKdbj.png")}else{if(!ez.iceOpen){mainUnlockFunction("The 🧊 Ice Cave!",ez,message,"https://i.imgur.com/oDmEVJ7.png",fs,db,"www.imgur.com/ZPOcmya.png","https://i.imgur.com/X43U9jS.png","https://i.imgur.com/geU1NFl.png","https://i.imgur.com/8rJQz8h.png","https://i.imgur.com/6Difbkk.png","https://i.imgur.com/QuiCnFB.png","https://i.imgur.com/jOp1HVm.png")}else{message.channel.send(`<@${message.member.id}> You've already unlocked all the 🌐 **bonus biomes!**`)}}}
}
exports.help = {
    name: 'unlock'
}
