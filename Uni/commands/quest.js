exports.run = async (bot,message,args) => {
    ...
    let o1 = sm.obj1
    console.log(`Quest - ${sm.quest}`)
    console.log(`Task - ${sm.task}`)
    if(args[0]=="done"){
        switch(sm.quest)
        {
            case 1:
